...
- у большинства сервисов — один бинарник `/server` → `/app/<service>` (torrent-store, magnet2torrent, external-proxy, torrent-web-seeder, torrent-web-seeder-cleaner, torrent-archiver, srt2vtt, subtitle-translate, video-info, torrent-http-proxy, rest-api)
